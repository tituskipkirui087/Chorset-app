...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/vending/billing/IabHelper;->consumeAsyncInternal(Ljava/util/List;Lcom/android/vending/billing/IabHelper$OnConsumeFinishedListener;Lcom/android/vending/billing/IabHelper$OnConsumeMultiFinishedListener;)V
.end annotation
...
.method public run()V
    ...
    .line 1076
    .local v2, "results":Ljava/util/List;, "Ljava/util/List<Lcom/android/vending/billing/IabResult;>;"
    iget-object v3, p0, Lcom/android/vending/billing/IabHelper$3;->val$purchases:Ljava/util/List;
    ...
    check-cast v1, Lcom/android/vending/billing/Purchase;

    .line 1078
    .local v1, "purchase":Lcom/android/vending/billing/Purchase;
    :try_start_0
    iget-object v4, p0, Lcom/android/vending/billing/IabHelper$3;->this$0:Lcom/android/vending/billing/IabHelper;

    invoke-virtual {v4, v1}, Lcom/android/vending/billing/IabHelper;->consume(Lcom/android/vending/billing/Purchase;)V
    ...
    invoke-virtual {v1}, Lcom/android/vending/billing/Purchase;->getSku()Ljava/lang/String;
    ...
    .line 1086
    .end local v0    # "ex":Lcom/android/vending/billing/IabException;
    .end local v1    # "purchase":Lcom/android/vending/billing/Purchase;
    :cond_0
    iget-object v3, p0, Lcom/android/vending/billing/IabHelper$3;->this$0:Lcom/android/vending/billing/IabHelper;

    invoke-virtual {v3}, Lcom/android/vending/billing/IabHelper;->flagEndAsync()V
    ...
    iget-object v3, p0, Lcom/android/vending/billing/IabHelper$3;->val$singleListener:Lcom/android/vending/billing/IabHelper$OnConsumeFinishedListener;

    if-eqz v3, :cond_1

    .line 1088
    iget-object v3, p0, Lcom/android/vending/billing/IabHelper$3;->val$handler:Landroid/os/Handler;

    new-instance v4, Lcom/android/vending/billing/IabHelper$3$1;

    invoke-direct {v4, p0, v2}, Lcom/android/vending/billing/IabHelper$3$1;-><init>(Lcom/android/vending/billing/IabHelper$3;Ljava/util/List;)V
    ...
    iget-object v3, p0, Lcom/android/vending/billing/IabHelper$3;->val$multiListener:Lcom/android/vending/billing/IabHelper$OnConsumeMultiFinishedListener;
    ...
    new-instance v4, Lcom/android/vending/billing/IabHelper$3$2;

    invoke-direct {v4, p0, v2}, Lcom/android/vending/billing/IabHelper$3$2;-><init>(Lcom/android/vending/billing/IabHelper$3;Ljava/util/List;)V
