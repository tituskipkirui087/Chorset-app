...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 76
    iget v1, p0, Lcom/gc/materialdesign/views/ButtonFlat;->radius:F

    invoke-virtual {p0}, Lcom/gc/materialdesign/views/ButtonFlat;->getHeight()I

    move-result v2

    iget v3, p0, Lcom/gc/materialdesign/views/ButtonFlat;->rippleSize:I
    ...
    iget v2, p0, Lcom/gc/materialdesign/views/ButtonFlat;->rippleSpeed:F

    add-float/2addr v1, v2

    iput v1, p0, Lcom/gc/materialdesign/views/ButtonFlat;->radius:F
    ...
    .line 82
    iget-object v1, p0, Lcom/gc/materialdesign/views/ButtonFlat;->onClickListener:Landroid/view/View$OnClickListener;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lcom/gc/materialdesign/views/ButtonFlat;->clickAfterRipple:Z
...
.method protected setAttributes(Landroid/util/AttributeSet;)V
    ...
    iput-object v4, p0, Lcom/gc/materialdesign/views/ButtonFlat;->textButton:Landroid/widget/TextView;

    .line 46
    iget-object v4, p0, Lcom/gc/materialdesign/views/ButtonFlat;->textButton:Landroid/widget/TextView;
    ...
    iget v5, p0, Lcom/gc/materialdesign/views/ButtonFlat;->backgroundColor:I
    ...
    invoke-virtual {p0, v4}, Lcom/gc/materialdesign/views/ButtonFlat;->addView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v4}, Lcom/gc/materialdesign/views/ButtonFlat;->setBackgroundColor(I)V
    ...
    .line 60
    .restart local v0    # "bacgroundColor":I
    :cond_3
    const-string v4, "http://schemas.android.com/apk/res/android"
    ...
    iput v4, p0, Lcom/gc/materialdesign/views/ButtonFlat;->background:I

    .line 61
    iget v4, p0, Lcom/gc/materialdesign/views/ButtonFlat;->background:I
